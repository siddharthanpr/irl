...
def euclidean_distance(x, y, sq=False):
    '''

    :param self: object
    :param x: vector 1 can be python lis or np.array
    :param y: vector 2 can be python lis or np.array
    :param sq: Boolean indicating if we want the euclidean squared or just jucleadean distance
    :return:
    '''
    s = 0
    assert len(x) == len(y)
